    ...
    return (
        <div id='LoginScreen'>
            <div className='LoginBody'>
                ...
                <h2 className='LoginBodyheader'>Sign in to Youtube</h2>
                <div className='LoginMain'>
                    <form onSubmit={handleSubmit}>
                        <input className='LoginEmailInput' type='text' name='email' onChange={HandleChange} placeholder='Email' />
                        <p className='LoginForget'>Forget Email?</p>
